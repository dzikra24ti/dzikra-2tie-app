...
function Typography(){
    return (
        <div className="m-4">
            ...
            <p className="text-blue-600 text-lg mt-2 ">Belajar Tailwind sangat menyenangkan dan cepat!</p>
        </div>
    )
}
...
function BorderRadius(){
    return (
        <button className="border-2 border-blue-500 text-blue-500 px-4 py-2 rounded-lg p-6 m-4"> Klik Saya </button>
    )
}

function BackgroundColors(){
    return(
        <div className="bg-rose-500 text-white p-6 rounded-lg shadow-lg">
...
function FlexboxGrid(){
    return (
        <nav className="flex justify-between bg-gray-800 p-4 mt-4 text-white ">
