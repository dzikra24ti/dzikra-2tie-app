...
import { useState, useEffect } from "react"; // Tambahkan useEffect ke import
...
export default function Notes() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      {/* Menggunakan komponen PageHeader yang di-import */}
  <PageHeader title="Notes" currentBreadcrumb="Notes List" />
